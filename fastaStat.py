...
def fastaStat(filename, fofn=False, concurrent=1):
    """
...
version: v0.1
    ...
    group.add_argument("-i", "--input", metavar='FASTAs', nargs="+", help="fasta files")
    group.add_argument("-f", "--fofn", help="file contains path of fasta files")
